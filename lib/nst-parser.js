...
//#TODO Fix here and there
	parse: function(o, src){
		...
		do{
			...
			if(!e && (this.scope > lastScope)){
				e = {text:s, label:"anonymous", line: this.line_idx, position: this.position, type: 'obj', hb:true};
				item = new mark('anonymous', this.line_idx, 'obj');
				item.ignore = true;
			}
...
parser.langs['Less'] = parser.langs['source.css'];
